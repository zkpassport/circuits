...
noir-profiler gates --artifact-path ./target/$package_name.json --backend-path $HOME/.bb/bb --output ./flamegraphs/$package_name
...
open -a "Google Chrome" ./flamegraphs/$package_name/main::gates.svg
