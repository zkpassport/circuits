...
export function generateEncapContentInfo(dg1Hash: Uint8Array, hashAlgorithm: HashAlgorithm) {
  ...
  ldsSecurityObject.dataGroups = [
    ...
    new ASN.DataGroupHash({
      ...
      // 0x01020304050607080102030405060708010203040506070801020304050607080102030405060708010203040506070801020304050607080102030405060708
      hash: new Uint8Array([
        ...
        0x05, 0x06, 0x07, 0x08,
      ]).slice(0, dg1Hash.length).buffer, // DG2 hash is truncated to match the length of DG1 hash
    }),
  ]
