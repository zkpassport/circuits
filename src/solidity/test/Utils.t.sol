...
abstract contract ZKPassportTest is Test {
  ...
  function deployZKPassport() internal returns (ZKPassportRootVerifier, ZKPassportSubVerifier) {
    ...
    // Deploy sub verifier with a placeholder default OPRF public key hash
    ZKPassportSubVerifier subVerifier = new ZKPassportSubVerifier(admin, rootVerifier, bytes32(0));
