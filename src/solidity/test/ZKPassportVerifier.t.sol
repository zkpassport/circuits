...
contract ZKPassportVerifierTest is TestUtils {
  ...
  uint256 constant CURRENT_DATE = 1758628390;
  uint256 constant PROOF_GENERATION_DATE = 1758627749;
  ...
  function test_VerifyValidProof() public {
    ...
    assertEq(
      scopedNullifier,
      bytes32(0x2065e14c01f142deef4e8670e21deb080c54729153cc6517859dd7c92f08ba07)
    );
