...
contract ZKPassportVerifierTest is TestUtils {
  ...
  bytes32 constant CERTIFICATE_REGISTRY_ROOT =
    bytes32(uint256(0x1bbe68fd0ee9098a1c7d9650a836a3448bfe4f1f22b51d27b15255bff11dff22));
  ...
  function test_VerifyValidProof() public {
    ...
    // Set the timestamp to 2025-07-15 10:08:29 UTC
    vm.warp(1752574109);
  ...
  function test_VerifyAllSubproofsProof() public {
    ...
    assertEq(currentDate, 1752537600);
    assertEq(minAge, 18);
    assertEq(maxAge, 0);
  ...
  function test_VerifyAllSubproofsProof_2() public {
    ...
    console.log(gasUsed);
    assertEq(currentDateBirthDate, 1752537600);
    assertEq(minDateBirthDate, 0);
    assertEq(maxDateBirthDate, 1752537600);
    ...
    console.log(gasUsed);
    assertEq(currentDateExpiryDate, 1752537600);
    assertEq(minDateExpiryDate, 1752537600);
