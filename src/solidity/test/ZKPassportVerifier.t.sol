...
contract ZKPassportVerifierTest is TestUtils {
  ...
  bytes32 constant CERTIFICATE_REGISTRY_ROOT =
    bytes32(uint256(0x2b1f25de1b7773f09f5a2ca4fce954101abc36db2701b69115c2404a95c81d18));
  bytes32 constant CERTIFICATE_REGISTRY_ROOT_2 =
    bytes32(uint256(0x2c7d26e6fe59c18a810ace75e939f198a7e182f20f91ca0f4fc30e6780133eb8));
  ...
  function test_VerifyAllSubproofsProof() public {
    ...
    assertEq(currentDate, 1749772800);
    assertEq(minAge, 18);
    assertEq(maxAge, 0);
  ...
  function test_VerifyAllSubproofsProof_2() public {
    ...
    console.log(gasUsed);
    assertEq(currentDateBirthDate, 1749772800);
    assertEq(minDateBirthDate, 0);
    assertEq(maxDateBirthDate, 1749772800);
    ...
    console.log(gasUsed);
    assertEq(currentDateExpiryDate, 1749772800);
    assertEq(minDateExpiryDate, 1749772800);
