...
import {DisclosedData, BoundData, FaceMatchMode, ProofVerificationData, ServiceConfig, OS, ProofType, ProofVerificationParams, IRootRegistry} from "../src/Types.sol";
